...
"""
    ...
    'OC', 'Distributor', 'Comment'

    Command line:
    python "%P/../BOM/bom_csv_grouped_by_value_with_fp.py" "%I" "%O.csv"
"""
...
for group in grouped:
    ...
    out.writerow([refs, len(group), c.getValue(), c.getPartName(), c.getFootprint(),
        ...
        c.getField("OC"), c.getField("Distributor"), c.getField("Comment")])
